...
/*********************************************************************
* Side Effects:	    UART2 (opto link) is configured
*
...
void OptoInit(void)
{		
		BAUDCON2bits.RXDTP=1;//DTRXP=1;	//RX inverted polarity
		BAUDCON2bits.TXCKP=1;//CKTXP=1;	//TX inverted polarity
        TRISDbits.TRISD7 = 1;
        TRISDbits.TRISD6 = 0;
        TXSTA2 = 0x24;
...
/*********************************************************************
* Side Effects:	    UART1 (USB virtual serial) is configured
*
* Overview:		    This function will configure the UART1 for use at 
*                   in 8 bits, 1 stop, no flowcontrol mode
********************************************************************/
void USBInit(void)
{
